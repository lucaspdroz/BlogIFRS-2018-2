...
var longAlert = {
	body: "<h1>[PROJETO EM ANDAMENTO]</h1> <p>Accepted in browsers [Aceito nos navegadores]:</p><pre>Chrome - 56.*</pre><pre>Chromium - 55.*</pre><b id='brave'>Brave - 0.12 - The current error is because of certificate<br> SSL(at moment i don't have, Sorry ;'(<br>[O erro que ocorre é devido o certificado SSL<br>(Que no momento não possuo, Me desculpe ;'(]</b> <p>PS: O Aplicativo [Beta] pode possuir diversas falhas, tais como lentidão, travamentos, má interpretação de fala, etc </p><h2>Comandos Aceitos</h2><ul><li>Recarregar (recarregará a página)</li>			<li>Olá(Irá lhe responder ;P)</li>			<li>Tchau(Irá lhe responder :P (pretendo finalizar o periodo de escuta))</li>		</ul>	<!--/* retirados temporariamente */				 <ul>		 	<li>Controles Musica(diga):		 		<ul>		 			<li>Play Music</li>		 			<li>tocar música</li>		 			<li>toque música</li>		 			<li>tocar músicas</li>		 		</ul>		 	</li>		 	<br>		 	<li>Controles do Player			 	<ul>			 		<li>Play</li>			 		<li>Pause</li>			 		<li>Stop</li>			 		<li>Próximo (Comando funciona, mas não há implementação para mudar música)</li>			 		<li>Voltar (Comando funciona, mas não há implementação para mudar música)</li>			 	</ul>		 	</li>	 </ul><br> -->		 <ul>		 	<li>Controles de Horario(diga):		 		<ul>		 			<li>Que horas são?</li>		 			<li>Horário</li>		 			<li>Horas</li>		 		</ul>		 	</li>		 </ul> <br>		 <ul>		 	<li>Controles de Data(diga):	 	<li>Que dia é hoje?</li>			 </ul> <br>		 <ul>		 	<li>Futuros comandos(já funcionando no console - F12)</li>		 	<li><pre>Liga luz</pre></li>		 	<li><pre>Desliga luz</pre></li>		 </ul>		 <ul>Perguntas 'pessoais'		 	<li><pre>Qual o seu nome?</pre></li><li>O que é você (ou para que você serve?)</pre></li><li><pre>Qual o meu nome?</li>		 </ul> " ,
	buttons: {
		action: {
			title: confirm,
			fn: basicModal.close
